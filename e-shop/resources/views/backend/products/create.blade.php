                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="seenInAllProduct" name="seenInAllProduct"
                                                    ...
                                                    {{ old('seenInAllProduct') == 'on' ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="seenInTrendingProducts"
                                                    name="seenInTrendingProducts" class="custom-control-input" value="on"
                                                    {{ old('seenInTrendingProducts') == 'on' ? 'checked' : '' }}>
